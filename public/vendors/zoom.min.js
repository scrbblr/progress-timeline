 ...
 */
function Zoom2(elem, config, wnd) {
...
Zoom2.prototype.previewZoom = function() {
...
Zoom2.prototype.setZoom = function(newZoom) {
    this.resultantZoom = newZoom;
    this.repaint();
};

Zoom2.prototype.finalize = function() {
    this.activeZoom = this.resultantZoom;
};

Zoom2.prototype.repaint = function() {
    this.elem.style.transform = this.resultantZoom2.css();
};

Zoom2.prototype.reset = function() {
...
Zoom2.prototype['reset'] = Zoom2.prototype.reset;
